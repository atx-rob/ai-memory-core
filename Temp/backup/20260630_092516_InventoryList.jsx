...
export default function InventoryList({ userId }) {
  ...
  const editBtn = { position: 'absolute', top: '15px', right: '60px', padding: '8px 16px', backgroundColor: 'var(--accent-color)', color: 'white', border: 'none', borderRadius: 'var(--border-radius)', cursor: 'pointer', fontWeight: '600' };
